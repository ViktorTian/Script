...
### Convert line endings (important for Windows users)
...
### Run the script (supports resume and safe restarts)
...
Script Features
1、 Automatic resume for interrupted extractions
2、 Skips already extracted categories (safe to rerun)
3、 Automatic class folder organization for both train and val
4、 Background execution supported (nohup recommended)
